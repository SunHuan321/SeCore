...
definition cpts_of_p :: "('s ann_prog) option \<Rightarrow> 's \<Rightarrow> ('s pconfs) set" where
...
definition lift :: "'s ann_prog \<Rightarrow> 's pconf \<Rightarrow> 's pconf" where
